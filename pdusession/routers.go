	...
	return []Route{
		{
			...
			HTTPReleasePduSession,
		},
		{
			"RetrievePduSession",
			http.MethodPost,
			"/pdu-sessions/:pduSessionRef/retrieve",
			HTTPRetrievePduSession,
		},
		{
			"TransferMoData",
			http.MethodPost,
		...
		},
		{
			...
			HTTPTransferMtDataIsmf,
		},
		{
			"ModifyPduSession",
			http.MethodPost,
			"/:$request.body#/vsmfPduSessionUri/modify",
			HTTPModifyPduSession,
		},
		{
			"ModifyPduSessionIsmf",
			http.MethodPost,
			"/:$request.body#/ismfPduSessionUri/modify",
			HTTPModifyPduSessionIsmf,
		},
		{
			"SmContextStatusNotificationPost",
			http.MethodPost,
			"/:$request.body#/smContextStatusUri",
			HTTPSmContextStatusNotificationPost,
		},
	}
}
