...
import (
	...
	"github.com/omec-project/http_wrapper" //nolint:gci
...
func BuildAndSendQosN1N2TransferMsg(smContext *smf_context.SMContext) error {
	...
	if err != nil {
		smContext.SubPduSessLog.Errorf(
			"SMPolicyUpdate, build PDUSession Resource Modify Request Transfer Error(%s)",
			err.Error(),
		)
	} else {
...
func NfSubscriptionStatusNotifyProcedure(
