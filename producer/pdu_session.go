...
func HandlePDUSessionSMContextUpdate(smContextRef string, body models.UpdateSmContextRequest) *http_wrapper.Response {
	...
	if body.BinaryDataN1SmMessage != nil {
		...
		N1messageHandler(m, body, response, smContext)
	} else {
		smContext.SubPduSessLog.Traceln("PDUSessionSMContextUpdate, Binary Data N1 SmMessage is nil!")
	}

	UpConnectionHandler(body, response, smContext)

	N2messageHandler(body, smContext, response)

	HandoverStateHandler(body, smContext, response)

	UpdateDataCauseHandler(body, smContext, response)
...
func N1messageHandler(m *nas.Message, body models.UpdateSmContextRequest, response models.UpdateSmContextResponse,
	smContext *smf_context.SMContext) {
	// var sendPFCPDelete bool
	...
	case nas.MsgTypePDUSessionReleaseRequest:
		...
		smContext.SubCtxLog.Traceln("PDUSessionSMContextUpdate, SMContextState Change State: ", smContext.SMContextState.String())
		evtData := fsm.PreparePfcpDeleteEventData(smContext)
		fsm.EventHandler(smContext, fsm.PFCPSessDelete, evtData)
...
func N2messageHandler(body models.UpdateSmContextRequest, smContext *smf_context.SMContext,
	...
	case models.N2SmInfoType_PDU_RES_SETUP_RSP:
		...
		evtData := fsm.PreparePfcpModEventData(pdrList, farList, qerList, barList, ANUPF.UPF.NodeID, smContext)
		fsm.EventHandler(smContext, fsm.PFCPSessModify, evtData)
...
func UpConnectionHandler(body models.UpdateSmContextRequest, response models.UpdateSmContextResponse,
	smContext *smf_context.SMContext) {
...
func HandoverStateHandler(body models.UpdateSmContextRequest, smContext *smf_context.SMContext,
	response models.UpdateSmContextResponse) {
...
func UpdateDataCauseHandler(body models.UpdateSmContextRequest, smContext *smf_context.SMContext,
	response models.UpdateSmContextResponse) {
